...
public class AdminHome extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Higher Secondary" }));

        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Class 10", "Class 11", "Class 12" }));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jComboBox3, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 138, javax.swing.GroupLayout.PREFERRED_SIZE)
       ...
       String course = (String)jComboBox1.getSelectedItem();
        ...
        try
        {
            Class.forName("com.mysql.jdbc.Driver");
               Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/newsrm","root","subarno");
      
                 Statement st = conn.createStatement();
         
               st.executeUpdate("insert into studentinfo(rollNo,course,branch,name,gender,fatherName) values('"+rollNo+"','"+course+"','"+branch+"','"+name+"','"+gender+"','"+fatherName+"')");
